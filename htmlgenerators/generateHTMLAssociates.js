  ...
  return `<!-- setting up william rowe info -->
    <section class="william-rowe">
      ...
      <p>
        ...
        <strong
          ><a
            href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Search&db=PubMed&term=rowe+wa[au]"
            >Dr. Rowe</a
          ></strong
        >
      </p>
    </section>
    <!-- setting up a section for robert werkman -->
    <section class="robert-werkman">
      <!-- added alt tag -->
      <img
        src="./assets/images/rfwerkman2.jpg"
        class="float-right"
        alt="robert-werkman"
      />
      ...
      <p>
        ...
        <strong
          ><a
            href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Search&db=PubMed&term=werkman+rf[au]"
            >Dr. Werkman</a
          ></strong
        >
      </p>
    ...
    <!-- setting up a section for carrie leese-->
    <section class="carrie-leese">
      <img
        src="./assets/images/Carrie2.jpg"
        class="float-left"
        alt="carrie-leese"
      />
